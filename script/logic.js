...
const formPhonePc = document.querySelector(".form-input input")
const formEmailInput = document.querySelector(".form-email__email input")
const formPasswordInput = document.querySelector(".form-email__password input")
const formPhoneEmailMobileTablet = document.querySelector(".form-mobile-tablet__input input")
...
accountBtn.addEventListener("click", (e) => registerBtn.click())
cartBtn.addEventListener("click", (e) => registerBtn.click())
...
checkFormInput(formPhonePc)
checkFormInput(formEmailInput)
checkFormInput(formPasswordInput)
checkFormInput(formPhoneEmailMobileTablet)
//* Click overlay close
overlayFull.addEventListener("click", (e) => {
    formLogin.classList.remove("show-on")
    formEmail.classList.remove("show-on")
